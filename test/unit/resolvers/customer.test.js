...
const dataSources = {
  ruralPaymentsCustomer: {
    ...
    getNotificationsFromLastYearByOrganisationIdAndPersonId: jest.fn()
  },
...
describe('CustomerBusiness', () => {
  ...
  beforeEach(() => {
    ...
    dataSources.ruralPaymentsCustomer.getNotificationsFromLastYearByOrganisationIdAndPersonId.mockImplementation(
      () => mockMessages
    )
  })
  ...
  describe('CustomerBusiness.messages', () => {
    test('get messages', async () => {
      ...
      expect(
        dataSources.ruralPaymentsCustomer.getNotificationsFromLastYearByOrganisationIdAndPersonId
      ).toHaveBeenCalledWith('4309257', 'mockpersonId')
